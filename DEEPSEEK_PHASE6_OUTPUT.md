# Phase 6 Followup Code and Console Outputs
...
log_file = open("DEEPSEEK_PHASE6_OUTPUT.md", "w")
log_file.write("# Phase 6 Followup Code and Console Outputs\n\n")
log_file.write("## Code Executed\n```python\n" + code + "\n```\n\n")
...
print("# Pseudocode for real correlation:")
print("data = pd.read_csv('mohe_magnetic.csv')")
print("gravity = pd.read_csv('mohe_gravity.csv')")
print("# Align timestamps")
print("# Compute cross-correlation")
print("# Plot both series")
...
```text
============================================================
SAA INTENSITY DECAY ANALYSIS
============================================================

--- AFRICAN CELL ---
Initial I0 = 23057.8 ± 5.1 nT
Decay rate k = 0.002090 ± 0.000015 per year
Half-life = 331.6 years
Exponential AIC: 24.81
Linear AIC: 18.78
Preferred: Linear

--- SOUTH AMERICAN CELL ---
Initial I0 = 22845.1 ± 3.5 nT
Decay rate k = 0.001144 ± 0.000010 per year
Half-life = 605.7 years
Exponential AIC: 20.31
Linear AIC: 21.48
...
============================================================
NORTH POLE DRIFT MODEL COMPARISON
============================================================

--- POST-1990 MODELS ---
Linear: slope=-3.5153 deg/year, intercept=280.09°E
Linear AIC: 190.26, BIC: 193.43

Exponential approach to 120°E:
  a = -547694.23 ± 233853419.71
  b = 0.0000 ± 0.0027
  c = -547534.14 ± 233853419.03
Exponential AIC: 192.27, BIC: 197.02
...
============================================================
MOHE 1997 CORRELATION NOTE
============================================================

To complete the Mohe analysis, we need:
1. Yumoto et al. 1997 magnetometer time series
2. Wang et al. 2000 gravity time series

If you can obtain these files, place them in the working directory
and run this correlation code:
...
============================================================
ANALYSIS COMPLETE - RAW OUTPUTS ONLY
============================================================
```
